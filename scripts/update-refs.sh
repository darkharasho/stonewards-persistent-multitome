...
# Keep in sync with the <Reference> items in src/PersistentMultiTome/PersistentMultiTome.csproj.
game_dlls=(Assembly-CSharp Mirror MyBox UnityEngine UnityEngine.CoreModule)
